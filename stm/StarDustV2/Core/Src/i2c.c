...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB3     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(BHI_I2C_SCL_GPIO_Port, BHI_I2C_SCL_Pin);

    HAL_GPIO_DeInit(BHI_I2C_SDA_GPIO_Port, BHI_I2C_SDA_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PB4     ------> I2C3_SDA
    */
    HAL_GPIO_DeInit(BMP_I2C_SCL_GPIO_Port, BMP_I2C_SCL_Pin);

    HAL_GPIO_DeInit(BMP_I2C_SDA_GPIO_Port, BMP_I2C_SDA_Pin);
